...
class SpanDetail(BaseModel):
    ...
    http_url: str = ""
    db_statement: str = ""
    #: Downstream HTTP detail. Empty means detail capture was not enabled;
    #: the UI says which, because blank and "not captured" are different
    #: facts. Response body is Python-empty/JS-populated by design -- see
    #: normalizer/schema/015_http_response_body.sql.
