...
class SpanRow(_Row):
    ...
    # Python-sourced spans: always empty (httpx's span closes before the body
    # is read). JS-sourced spans: populated when captureHttpDetail is on and
    # the response wasn't skipped by content-type/size cap. See
    # normalizer/schema/015_http_response_body.sql for the full story.
