-- CLOUD OVERRIDE of schema/004_trace_assembly.sql -- identical except for
-- the two ENGINE lines. See schema-cloud/001_spans_raw.sql's header for
-- why. trace_locator's ReplacingMergeTree version-column argument
-- (first_seen) is kept -- only the zookeeper_path/replica_name pair is
-- Cloud-managed, not the engine's own parameters.
--
-- U2: trace assembly.
--
...
ENGINE = ReplicatedReplacingMergeTree(first_seen)
